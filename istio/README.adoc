...
With the cloud services platform you can better control traffic with dynamic route configuration and it is easier to conduct A/B tests and make canary release. You not only just manage the implementation and deployment of a service but also manage the service itself as it is running.
...
- Istio 入伙 kubernetes 生态圈，Google 微服务版图里程碑式扩张 https://zhuanlan.zhihu.com/p/35546641
